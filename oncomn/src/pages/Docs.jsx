      ...
      <div className="docs-container">
        ...
        <main className="docs-main">
          <div className="docs-intro">
            <h1>Dokumentasi Oncomn</h1>
            <p>Panduan lengkap untuk membantu Anda mengintegrasikan dan menggunakan platform Oncomn.</p>
          </div>
          <section id="getting-started" className="docs-section">
            <h2>Memulai</h2>
            <div className="section-content">
              <h3>Instalasi</h3>
              <p>Tambahkan Oncomn ke proyek Anda menggunakan npm.</p>
              <CodeBlock>npm install oncomn-ai --save</CodeBlock>

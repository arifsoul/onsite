...
<body>
  <header class="header">
    <h1>Onsite AI Frontend Generator</h1>
    <nav>
      <ul>
  ...
  <main>
    <section class="hero">
      <h2>Create Stunning Websites Instantly</h2>
      <p>Generate responsive, professional-grade frontend code with AI.</p>
      ...
      <div className="code-preview">
        <div className="code-tabs">
          {[
            ...
            <div key={lang} className="tab-container">
              <button
              ...
              <button
                ...
                onClick={() => copyToClipboard(localCode[lang])}
                title="Copy Code"
              >

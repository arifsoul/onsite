        ...
        messages: [
          {
            role: 'system',
            content:
              'You are an AI that generates React component code for a website based on user descriptions. Return structured JSON with fields: jsx, css, jsx, and components array listing sub-components (e.g., ["Header", "About", "Projects", "Contact", "Footer"]). Example: ```json\n{"jsx": "<div>...</div>", "css": ".class { ... }", "js": "import React from \'react\'; function Component() { return <div>...</div>; }", "components": ["Header", "Footer"]}\n```. Ensure the code includes portfolio-specific sections like About, Projects, and Contact.',
          },

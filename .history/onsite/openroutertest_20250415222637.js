        ...
        messages: [
          {
            role: 'system',
            content:
              'You are an AI that generates website code based on user descriptions. Return structured JSON with fields: html, css, js, and components array listing sub-components (e.g., ["Header", "Main", "Footer"]). Example: ```json\n{"html": "<div>...</div>", "css": ".class {...}", "js": "function ...", "components": ["Header", "Main", "Footer"]}\n```',
          },
...
console.log('Welcome to Website Code Generator CLI');
promptUser();